...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--bars", type=int, default=150, help="Count of bars to feed into the model")
    ...
    parser.add_argument("--type", default="transformers", help="FF to use simple Feedforward network, conv to use vonvolution model and transformers for transformers")
    ...
    env = environ.StocksEnv({"TEST": prices}, bars_count=args.bars, reset_on_close=False, commission=args.commission,
                            state_1d=args.type, random_ofs_on_reset=False, reward_on_close=False, volumes=False)
    if args.type=="conv":
        ...
        net =models.DQNTransformer(env.observation_space.shape, env.action_space.n)
