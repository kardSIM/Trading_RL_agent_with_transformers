...
if __name__ == "__main__":
    ...
    saves_path = SAVES_DIR / f"transformers_f-{args.run}"
    ...
    net = models.DQNTransformer(env.observation_space.shape, env.action_space.n).to(device)
    ...
    tb = common.setup_ignite(engine, exp_source, f"transformers_f-{args.run}",
